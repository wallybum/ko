...
$(function(){
    ...
    if($("#wrap").hasClass("index")){
        ...
        var mVis = $('#indexwrap').fullpage({
            anchors: ['intro', 'index01', 'index02', 'index03', 'index04', 'index05'],
            menu: '#gnb',
            dragAndMove: true,
            scrollOverflow: true,
		...
		if ( (navigator.appName == 'Netscape' && agent.indexOf('trident') != -1) || (agent.indexOf("msie") != -1)) {
			$('.index03 .pref-bx').addClass('ie');
			 mPrefSlide = new Swiper('.index03 .pref-bx .side-bx', {
				speed: 400,
				spaceBetween: 100,
				pagination: {
					el: '.index03 .pager',
        ...
        var mAtSlide = new Swiper('.index04 .auto-bx .side-bx', {
            speed: 400,
            slidesPerView: 'auto',
            spaceBetween: 0,
            slidesPerGroup:3,
